...
from habits.views import HabitCreateAPIView, HabitUpdateAPIView, HabitDestroyAPIView, HabitPublishedListAPIView, \
...
urlpatterns = [
    ...
    path('user/habits/', HabitUserListAPIView.as_view(), name='habits_user'),
